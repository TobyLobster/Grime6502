...
; ****************************************
.title_screen_cells
    equb 0,   0,   0,   9,   9,   0,   9,   9,   9,   0,   0,   9
    equb 0,   0,   9,   9,   9,   0,   9,   0,   9,   9,   0,   0
    equb 9,   0,   9,   0,   0,   9,   9,   0,   0,   9,   9,   0
    equb 9,   9,   0,   9,   0,   9,   9,   9,   0,   0,   9,   0
    equb 0,   9,   0, &0d, &0d,   0,   0, &0d, &0d,   0,   0, &0d
    equb 0,   0, &0d,   0, &0d,   0,   9,   0, &0d, &0d,   0,   9
    equb 9,   0, &0d,   0,   0,   0,   0, &0d,   0, &0d,   0, &0d
    equb 0, &0d,   0, &0d,   0, &0d,   0, &0d,   0,   0,   9,   0
    equb 9,   0, &0d,   0, &0d, &0d,   0, &0d, &0d,   0,   0, &0d
    equb 0, &0d,   0,   0,   0, &0d,   0, &0d, &0d,   0,   9,   0
    equb 9,   0, &0d,   0,   0, &0d,   0, &0d,   0, &0d,   0, &0d
    equb 0, &0d,   0,   9,   0, &0d,   0, &0d,   0,   0,   9,   0
    equb 0,   9,   0, &0d, &0d,   0,   0, &0d,   0, &0d,   0, &0d
    equb 0, &0d,   0,   9,   0, &0d,   0,   0, &0d, &0d,   0,   9
    equb 9,   0,   9,   0,   0,   9,   0,   0,   0,   0,   0,   0
    equb 9,   0,   0,   9,   9,   0,   0,   9,   0,   0,   9,   0
    equb 0,   9,   9,   9,   9,   0, &0d, &0d,   0, &0d, &0d, &0d
    equb 0,   0, &0d,   0,   0, &0d, &0d,   0,   9,   9,   9,   9
    equb 0,   9,   9,   9,   0, &0d,   0,   0,   0, &0d,   0,   0
    equb 0, &0d,   0, &0d,   0,   0,   0, &0d,   0,   9,   9,   0
    equb 0,   0,   9,   9,   0, &0d, &0d,   0,   0, &0d, &0d,   0
    equb 0, &0d,   0, &0d,   0,   0, &0d,   0,   9,   9,   9,   0
    equb 9,   9,   9,   9,   0, &0d,   0, &0d,   0,   0,   0, &0d
    equb 0, &0d,   0, &0d,   0, &0d,   0,   0,   9,   9,   9,   9
    equb 0,   9,   0,   9,   9,   0, &0d,   0,   0, &0d, &0d,   0
    equb 9,   0, &0d,   0,   0, &0d, &0d, &0d,   0,   9,   0,   0
    equb 0,   0,   9,   9,   9,   9,   0,   9,   9,   0,   0,   9
    equb 9,   9,   0,   9,   9,   0,   0,   0,   9,   9,   9,   0
    equb 0,   0,   0,   9,   9,   9,   9,   9,   9,   9,   9,   9
    equb 0,   9,   9,   9,   9,   9,   9,   9,   0,   0,   9,   0
    equb 0,   0,   9,   0,   9,   0,   0,   9,   0,   9,   0,   0
    equb 9,   0,   0,   0,   9,   0,   0,   9,   0,   0,   0,   0

; ****************************************
.random_source
    equb &8b, &0d, &1a, &52, &9c, &4e, &f6, &37
...
.read_both_controls
    ; Return with:
    ;
    ;  z_as contains two bits for each axis:
    ;
    ;       00 - neutral
    ;       01 - high
    ;       10 - low
